...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    tankDrive = new TankDrive(
      () -> oi.getY() * RobotMap.JOYSTICK_SENSITIVITY, 
      () -> oi.getX() * RobotMap.JOYSTICK_SENSITIVITY,
      new VictorSPMotor(RobotMap.FL_MOTOR_PORT), 
      new VictorSPMotor(RobotMap.FR_MOTOR_PORT), 
      new VictorSPMotor(RobotMap.BL_MOTOR_PORT), 
      new VictorSPMotor(RobotMap.BR_MOTOR_PORT));
  }
